...
{
    /// <summary>
    /// Exception thrown when a file format is invalid or not supported.
    /// </summary>
    public class InvalidFormatException : PdftractException
    {
        private const string ErrorCodeValue = "INVALID_FORMAT";
