...
{
    /// <summary>
    /// Exception thrown when permission is denied to access a resource.
    /// </summary>
    public class PermissionDeniedException : PdftractException
    {
        private const string ErrorCodeValue = "PERMISSION_DENIED";
