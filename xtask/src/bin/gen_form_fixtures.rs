...
fn create_acroform_readonly_pdf() {
    ...
    // Save PDF
    doc.save("tests/fixtures/forms/acroform-readonly.pdf").unwrap();
...
fn create_acroform_submit_pdf() {
    ...
    // Save PDF
    doc.save("tests/fixtures/forms/acroform-submit.pdf").unwrap();
...
<xdp:xdp xmlns:xdp=\"http://ns.adobe.com/xdp/\">
  ...
  <template xmlns=\"http://www.xfa.org/schema/xfa-template/2.8/\" />
    ...
    // Save PDF
    doc.save("tests/fixtures/forms/xfa-dynamic.pdf").unwrap();
